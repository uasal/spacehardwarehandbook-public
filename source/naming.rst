...
For mechanical assemblies we have adopted the approach described below. For example, a subassembly such as the JWST Aft-Optics Assembly (AOA) houses a fictitous Extra-Solar Coronagraph instrument:
