...
- Only low-out-gassing (per `<https://etd.gsfc.nasa.gov/capabilities/outgassing-database/>`__) lubricants (e.g. Bray-Coat) and adhesives (e.g. 2216 A/B Gray) will be used in the payload.
